...
> This app was extracted from the Flow Hub email designer into a standalone,
> self-contained product. It has its own database, auth, billing and API and is
> ready to live in its own repository.
